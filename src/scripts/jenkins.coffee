...
#
# Commands:
#   hubot ramya b <jobNumber> - builds the job specified by jobNumber. List jobs to get number.
#   hubot ramya build <job> - builds the specified Jenkins job
#   hubot ramya build <job>, <params> - builds the specified Jenkins job with parameters as key=value&key2=value2
